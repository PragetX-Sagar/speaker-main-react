...
function EventError(){
    ...
    return (
        ...
        <div className='fp-addevent'>
            ...
            <img src={require("../components/images/EventsPage2.png")} style={{ height: '100%' }} alt={""} />
            ...
            <Box sx={ style }>
                ...
                <Box sx={{
                    ...
                    <Box sx={{
                        ...
                        <Button href="/login" variant="contained" style={{
                            backgroundColor: '#ffbf19',
                            borderColor: '#ffbf19',
                            color: '#333',
                            width: '100%'
                    ...
                    <Box sx={{
                        ...
                        <Button href="/login" variant="outlined" style={{
